...
export default function ConfirmCounselorRemarkDeleteModal({ open, loading, onCancel, onConfirm }) {
  const title = 'Delete Counselor Remark'
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-2xl">
        <div className="border-b border-slate-100 px-6 py-5">
          ...
          <p className="mt-2 text-[14px] leading-relaxed text-slate-600">
            Are you sure you want to delete this counselor remark? This action cannot be undone.
          </p>
        </div>
