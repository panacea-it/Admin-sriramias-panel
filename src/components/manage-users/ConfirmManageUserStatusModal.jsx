...
export default function ConfirmManageUserStatusModal({
  ...
  const title = enabling ? 'Enable User' : 'Disable User'
  const message = enabling
    ? 'Are you sure you want to enable this user? The user will regain access to the system.'
    : 'Are you sure you want to disable this user? The user will no longer be able to access the system until re-enabled.'
  const confirmLabel = enabling ? 'Enable User' : 'Disable User'
