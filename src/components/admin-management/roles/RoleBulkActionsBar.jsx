...
export default function RoleBulkActionsBar({
  count,
  disableCount = 0,
  deleteCount = 0,
  onDisable,
  ...
  const label = count === 1 ? '1 Role Selected' : `${count} Roles Selected`
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-rose-600 to-orange-500 px-3.5 py-2 text-xs font-semibold text-white shadow-sm transition hover:opacity-95 disabled:cursor-not-allowed disabled:opacity-50 sm:text-sm"
        >
