...
export default function SubjectListingStatus({ status, onChange, disabled = false }) {
  ...
  return (
    <AdminTooltip label={active ? 'Click to disable' : 'Click to enable'}>
      <button
        type="button"
        role="switch"
        aria-checked={active}
        ...
        className={cn(
          ...
          active
            ...
            : 'border-red-200/80 bg-red-50/90 text-red-800 shadow-sm',
      ...
      >
        <span
          className={cn(
            ...
            active ? 'bg-emerald-500 shadow-[0_0_0_3px_rgba(16,185,129,0.2)]' : 'bg-red-500 shadow-[0_0_0_3px_rgba(239,68,68,0.15)]',
          )}
        />
