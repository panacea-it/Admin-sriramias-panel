...
export default function ExamCategoryFilterBar({
  ...
  return (
    <div className="flex min-h-[52px] flex-wrap items-center gap-3 rounded-2xl border border-white/80 bg-white px-3 py-3 shadow-[0_8px_24px_rgba(15,23,42,0.08)] sm:px-4">
