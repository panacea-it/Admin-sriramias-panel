...
const COPY = {
  enable: {
    ...
    message: 'Are you sure you want to enable all selected resources?',
    confirmLabel: 'Enable',
  ...
  disable: {
    ...
    message: 'Are you sure you want to disable all selected resources?',
  ...
  delete: {
    ...
    message: 'Are you sure you want to permanently delete all selected resources?',
    confirmLabel: 'Delete',
