...
export function useExamSubCategoryManagement() {
  const [subCategories, setSubCategories] = useState(() => getInitialState().subCategories)
  ...
  const fetchSubCategories = useCallback(
    async ({ bypassCache = false, ignoreFlag } = {}) => {
      ...
      await runGuardedListFetch({
        ...
        applyData: (data) => setSubCategories(normalizeExamSubCategoriesListResponse(data)),
