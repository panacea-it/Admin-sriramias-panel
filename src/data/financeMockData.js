...
export const MOCK_OFFLINE_REQUESTS = [
  ...
  },
  {
    ...
    reconciliationNotes: 'â‚¹1,000 short in daily cash tally',
    duplicateStatus: 'Unique',
    approvedBy: 'Ankit Gupta',
    auditTrail: [
    ...
    notificationLog: [
      {
        id: 'N-OFF-004',
        channel: 'In-app',
        message: 'Duplicate receipt detected â€” review required',
        read: false,
        timestamp: daysAgo(2),
      },
    ],
  ...
  },
  {
    ...
    duplicateStatus: 'Unique',
    approvedBy: 'Kavya Nair',
    rejectedBy: 'Branch Admin',
    rejectionReason: 'No valid receipt uploaded â€” blurry image rejected',
    auditTrail: [
...
export const MOCK_EMI_PLANS = [
  ...
  },
  {
    ...
    suspensionReason: 'EMI unpaid for 18 days â€” auto suspension',
  ...
  },
  {
    ...
    pendingAmount: 45000,
    completionPercent: 40,
    emiStartDate: daysAgo(60),
    emiEndDate: daysAgo(-120),
    emiDurationMonths: 6,
    planStatus: 'EMI Running',
    status: 'EMI Running',
    loanProvider: 'Institute EMI',
    ...
    overdueAmount: 0,
    providerStatus: 'EMI Active',
    providerRefId: 'INST-EMI-ARJ-01',
    planHistory: [
      { action: 'EMI plan activated for UPSC Foundation', by: 'Finance Admin', at: daysAgo(90) },
    ],
    reminderLogs: [],
    callLogs: [],
    bounceLogs: [],
    ...
    installments: [
      {
        ...
        paidDate: daysAgo(58),
        paymentMode: 'UPI',
        utrNumber: 'TXN-ARJ-001',
        receiptNumber: 'RCP-ARJ-E1',
        paymentHistory: [{ action: 'Paid via UPI', at: daysAgo(58), by: 'Finance Admin' }],
      },
      {
        emiNo: 2,
        installmentNo: 2,
        ...
        paidDate: daysAgo(28),
        paymentMode: 'Card',
        utrNumber: 'TXN-ARJ-002',
        receiptNumber: 'RCP-ARJ-E2',
        paymentHistory: [{ action: 'Card payment verified', at: daysAgo(28), by: 'Finance Admin' }],
      },
      {
        emiNo: 3,
        installmentNo: 3,
        ...
        studentSubmission: {
          paymentMode: 'UPI',
          utrNumber: 'TXN-ARJ-STU-003',
          proofFileName: 'arjun-upi-mar.jpg',
          paidAmount: 7500,
          paidDate: daysAgo(1),
          remarks: 'Submitted via student portal â€” partial payment',
