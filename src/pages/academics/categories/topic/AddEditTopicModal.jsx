...
import { mapApiTopicToLocal } from './topicHelpers'

function buildForm(item) {
  if (item) {
    const mapped = mapApiTopicToLocal(item) || item
    return {
  ...
  return { subjectId: '', name: '', description: '', status: 'Active' }
}
...
export default function AddEditTopicModal({
  ...
  const title = isEdit ? 'Edit Topics' : 'Add Topics'
